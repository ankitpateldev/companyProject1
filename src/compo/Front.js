...
function Front() {
  return (
    ...
    <div className="container-fluid" style={{ backgroundColor: 'blue' }}>
      <img src="https://i.imgur.com/Or1gp5X.png" alt="himg" className="img-fluid" />
    </div>
    <div className="ctl-main-head" style={{
     display:'block',
        fontStyle: "normal",
        fontWeight: "600",
        lineHeight: "14px",
      ...
      <h4>America's Premier Supplier Of Custom Canopy Tents With Logo</h4>
    </div>
    <div className="container-fluid p-0">
      <div className="productlist text-center">
        <div className="container" style={{ padding: '40px 0' }}>
          <p>
            Starline Exhibits International CustomTentwithLogo.com is the premier creator of high-quality banners and tents to fit the marketing needs of any company. With a track record that spans a decade, we print custom pop up tents and canopies for our clients at a reasonable cost. Built with durability in mind, our dye sublimation techniques ensure that the prints we give to our clients keep lasting well into the future. We can even offer personalized branding for your shade covers, making your brand stand out from your competitors. You need custom canopy tents on a crowded expo floor to let the audience know where you are and what you offer. We can make that happen to your specifications.
          </p>
          <p>
